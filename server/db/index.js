...
const syncAndSeed = async () => {
    ...
    const project1 = await Project.create({
      ...
      onRender: 'https://emotion-flashcards-project.onrender.com',
  ...
  const project2 = await Project.create({
    ...
    onRender: 'https://lozier-school-management.onrender.com',
    techUsed: ['vanilla JS', "css", 'postsql', 'node', 'express', 'redux', 'react'],
  ...
  const project3 = await Project.create({
    ...
    gitHub: 'https://github.com/sllozier/flintstones-grace-shopper',
    onRender: 'https://flintstones-grace-shopper.onrender.com',
    techUsed: ['vanilla JS', "css", 'postsql', 'node', 'express', 'redux', 'react'],
